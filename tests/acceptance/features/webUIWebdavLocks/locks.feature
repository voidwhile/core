...
Feature: Locks
  ...
  Scenario: setting a lock shows the user name of a user in the locking details (user has set email address)
    ...
    And folder "simple-folder" should be marked as locked by user "user-with-email" in the locks tab of the details panel on the webUI
    And file "data.zip" should be marked as locked by user "user-with-email" in the locks tab of the details panel on the webUI
